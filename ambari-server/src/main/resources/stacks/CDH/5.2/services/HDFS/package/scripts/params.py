...
if cluster_stack_version != "" and compare_versions(cluster_stack_version, '2.0') >= 0 and compare_versions(cluster_stack_version, '2.1') < 0 and System.get_instance().os_family != "suse":

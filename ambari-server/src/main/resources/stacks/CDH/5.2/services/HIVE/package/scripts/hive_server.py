...
class HiveServer(Script):
  ...
  def configure(self, env):
    ...
    if not (params.cluster_stack_version != "" and compare_versions(params.cluster_stack_version, '5.2') >=0):
      install_tez_jars()
  ...
  def pre_rolling_restart(self, env):
    ...
    if params.version and compare_versions(format_hdp_stack_version(params.version), '5.2') >= 0:

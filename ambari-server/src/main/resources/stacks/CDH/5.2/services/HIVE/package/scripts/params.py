...
stack_is_hdp21 = cluster_stack_version != "" and compare_versions(cluster_stack_version, '2.1') >= 0 and compare_versions(cluster_stack_version, '2.2') < 0
...
pig_tar_file = '/usr/share/CDH-webhcat/pig.tar.gz'
hive_tar_file = '/usr/share/CDH-webhcat/hive.tar.gz'
sqoop_tar_file = '/usr/share/CDH-webhcat/sqoop*.tar.gz'
...
if cluster_stack_version != "" and compare_versions(cluster_stack_version, '5.2') >=0:

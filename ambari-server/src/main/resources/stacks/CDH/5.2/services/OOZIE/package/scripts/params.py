...
if security_enabled and cluster_stack_version != "" and compare_versions(cluster_stack_version, '5.0') < 0:
...
if cluster_stack_version != "" and compare_versions(cluster_stack_version, '4.0') >= 0 and compare_versions(cluster_stack_version, '5.0') < 0:

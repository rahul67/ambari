...
cosmos_collectd_lock_file = status_params.cosmos_collectd_lock_file
...
resourcemanager_json_template = config['configurations']['cosmos-env']['jmx-resourcemanager-content']
nodemanager_json_template = config['configurations']['cosmos-env']['jmx-nodemanager-content']

...
spark_yarn_jar = namenode_address + spark_yarn_jar.strip()
...
spark_defaults['spark.yarn.jar'] = spark_yarn_jar
...
zeppelin_server_pid_file = status_params.zeppelin_server_pid_file
